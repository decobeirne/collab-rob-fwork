#ifndef ROBOT_MATHS_H
#define ROBOT_MATHS_H
...
//! Multiplye a 2x2 matrix by a 2-D point.
PointF Maths_multMatrixByPoint (const float *A, const PointF P);

//! Add 2x2 matrices A and B
...
int uchar_lessThan (const uchar a, const void *b);

//! Return 1 if a is greater than b
int uchar_greaterThan (const uchar a, const void *b);

//! Returns 1 if a equals b
int uchar_equals (const uchar a, const void *b);
...
//! Calculate motor burst in micro seconds required for given distance
